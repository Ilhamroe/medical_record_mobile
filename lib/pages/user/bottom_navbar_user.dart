...
import 'package:e_klinik_pens/pages/user/medical_record_history_user.dart';
        ...
        bottomNavigationBar: Container(
          ...
          child: BottomAppBar(
            ...
            child: Row(
              ...
              children: [
                MaterialButton(
                  padding: const EdgeInsets.symmetric(horizontal: 1.0).w,
                ...
                MaterialButton(
                  ...
                  onPressed: () {
                    setState(() {
                      currentScreen = const MedicalHistoryUser();
                      currentTab = 2;
                    });
                  },
                  child: currentTab == 2
