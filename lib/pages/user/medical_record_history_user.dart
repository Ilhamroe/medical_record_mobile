...
import 'package:e_klinik_pens/widgets/user/medicalHistoryUser_tiles.dart';
...
class MedicalHistoryUser extends StatefulWidget {
  ...
  @override
  State<MedicalHistoryUser> createState() => _MedicalHistoryUserState();
}

class _MedicalHistoryUserState extends State<MedicalHistoryUser> {
  final int contoh = 1;
